...
export const BattingControls: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-4 left-0 right-0 pointer-events-none flex flex-col items-center justify-center select-none z-20">
      ...
      <div className="bg-[#0B1220]/80 backdrop-blur-md px-5 py-2 rounded-full border border-[#23304E] shadow-xl flex items-center space-x-6 text-xs text-[#8A93A6] font-medium">
